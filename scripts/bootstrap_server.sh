...
echo "==> Done"
echo "Next:"
echo "  1. Upload OHLCV parquet to data/binance/"
echo "  2. export TQG_API_KEY=..."
echo "  3. python scripts/tqg_init.py"
echo "  4. Configure Cursor MCP (tqg_client/mcp_config.example.json)"
echo "  5. Connect Cursor to this server via SSH remote workspace"
